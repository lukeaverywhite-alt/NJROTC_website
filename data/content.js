...
window.SITE_CONTENT = {
  ...
  drillPrograms: [
    ...
    { id: 'drill-team', title: 'Drill Team', description: 'Build teamwork, leadership, command presence, and precision through coordinated competition drill.', image: 'assets/drill/Drill-Overview.JPEG', imageAlt: 'Ten uniformed cadets stand in an outdoor formation.', url: 'pages/drill-team.html', category: 'Competition drill', order: 20, enabled: true, verifiedOn: '2026-09-05' },
