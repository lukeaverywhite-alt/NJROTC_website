...
window.SITE_CONTENT = {
  ...
  drillPrograms: [
    { id: 'color-guard', title: 'Color Guard', description: 'Represent the unit with dignity, precision, and respect for the colors at ceremonies and events.', image: 'assets/drill/color-guard.jpg', imageAlt: 'Four cadets present the colors while marching outdoors.', url: 'pages/color-guard.html', category: 'Ceremonial drill', order: 10, enabled: true, verifiedOn: '2026-09-05' },
    { id: 'drill-team', title: 'Drill Team', description: 'Build teamwork, leadership, command presence, and precision through coordinated competition drill.', image: 'assets/drill/drill-overview.jpg', imageAlt: 'Ten uniformed cadets stand in an outdoor formation.', url: 'pages/drill-team.html', category: 'Competition drill', order: 20, enabled: true, verifiedOn: '2026-09-05' },
    { id: 'unarmed-drill', title: 'Unarmed Drill', description: 'Practice regulation formations, marching, facing movements, cadence, alignment, and commands without rifles.', image: 'assets/drill/unarmed-drill.jpg', imageAlt: 'A cadet commands an unarmed platoon outdoors.', url: 'pages/unarmed-drill.html', category: 'Regulation drill', order: 30, enabled: true, verifiedOn: '2026-09-05' },
    { id: 'armed-drill', title: 'Armed Drill', description: 'Perform regulation drill and approved manual-of-arms movements with the unit’s demilitarized drill rifles.', image: 'assets/drill/armed-drill.jpg', imageAlt: 'An armed platoon marches in formation outdoors.', url: 'pages/armed-drill.html', category: 'Regulation drill', order: 40, enabled: true, verifiedOn: '2026-09-05' },
