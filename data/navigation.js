...
window.NAVIGATION = [
  ...
  { id: 'cadets', title: 'Cadet Hub', order: 20, enabled: true, children: [
    ...
    { id: 'cadet-field-manual', title: 'Cadet Field Manual', url: 'pages/cadet-field-manual.html', order: 70, enabled: true },
    { id: 'weather', title: 'Weather', url: 'pages/weather.html', order: 80, enabled: true },
    { id: 'wellness', title: 'Wellness', url: 'pages/wellness.html', order: 90, enabled: true }
  ] },
